...
#Configuração do Git Localmente
	...
	git config --global user.name "Robson aluno"
	
	#Seu endereço de e-mail que vai ser utilizado em qualquer commit (confirmação) recém-criado.
	git config --global user.email robsonaluno@gmail.com
...
https://github.com
	...
	New Repository
		...
		Manage topics: git github bash shell linux linux-mint
			Link: https://github.com/aluno/devops.git
			Link: https://github.com/aluno/devops
...
git clone https://github.com/aluno/devops.git
cd devops
ls -lha
